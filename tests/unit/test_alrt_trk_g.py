...
class Alert:
    ...
    def __eq__(self, other):
        ...
        return self.satellite_id == other.satellite_id and self.severity == other.severity and self.component == other.component and self.timestamp == other.timestamp
...
class AlertTracker:
    ...
    def process_log_entry(self, log_entry: LogEntry) -> Optional[Alert]:
        ...
        if len(self.violation_timestamps[key]) >= VIOLATION_THRESHOLD:
            ...
            return Alert(satellite_id=log_entry.sat_id, severity=alert_type, component=log_entry.cmpnt, timestamp=oldest_violation)
...
class TestAlertingConditions:
    ...
    def test_sample_data_replication(self, tracker):
        ...
        expected_alerts = [
            Alert(satellite_id=1000, severity="RED LOW", component="BATT", timestamp=datetime(2018, 1, 1, 23, 1, 9, 521000)),
            Alert(satellite_id=1000, severity="RED HIGH", component="TSTAT", timestamp=datetime(2018, 1, 1, 23, 1, 38, 1000)),
        ]
